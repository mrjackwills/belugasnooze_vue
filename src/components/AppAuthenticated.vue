...
import type { TData, TError, TTime, TTimeAndTimeZone, TWSFromPi } from '@/types'
...
function cacheTime (timezone: string): TTimeAndTimeZone {
...
function wsDataHandler (message: TWSFromPi): void {
	init.value = true
	initCount.value = 0
